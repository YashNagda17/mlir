...
set PROJ_C=parser.c tokenizer.c mlir_parser.c mlir_classic_printer.c mlir_generic_printer.c op_parsers.c mlir_op_names.c mlir_api_dispatch.c
...
link /nologo /out:parser_upstream.exe ^
    ...
    op_parsers.obj mlir_op_names.obj mlir_api_dispatch.obj mlir_api_impl_upstream.obj ^
