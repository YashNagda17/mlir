...
set PROJ_C=parser.c tokenizer.c mlir_parser.c mlir_classic_printer.c mlir_generic_printer.c op_parsers.c mlir_op_names.c mlir_api_common_literals.c mlir_lower_to_llvm.c mlir_translate_to_llvm_ir.c mlir_wasm_to_wat.c mlir_llvm_to_wasmssa.c mlir_wasmssa_to_wasmstack.c mlir_wasmstack_to_bin.c mlir_lift_cf_to_scf.c
...
link /nologo /out:parser_upstream.exe ^
    ...
    op_parsers.obj mlir_op_names.obj mlir_api_common_literals.obj mlir_lower_to_llvm.obj mlir_translate_to_llvm_ir.obj mlir_wasm_to_wat.obj mlir_llvm_to_wasmssa.obj mlir_wasmssa_to_wasmstack.obj mlir_wasmstack_to_bin.obj mlir_lift_cf_to_scf.obj mlir_api_impl_upstream.obj ^
