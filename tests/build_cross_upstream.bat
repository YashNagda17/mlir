...
set PROJ_C=tests\cross\driver.c mlir_generic_printer.c mlir_op_names.c mlir_lower_to_llvm.c mlir_translate_to_llvm_ir.c mlir_translate_to_wasm.c
...
link /nologo /out:cross_upstream.exe ^
    upstream_main.obj driver.obj mlir_generic_printer.obj mlir_op_names.obj mlir_lower_to_llvm.obj mlir_translate_to_llvm_ir.obj mlir_translate_to_wasm.obj mlir_api_impl_upstream.obj ^
