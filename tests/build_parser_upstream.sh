...
PROJ_C_FILES="parser.c tokenizer.c mlir_parser.c mlir_classic_printer.c mlir_generic_printer.c op_parsers.c mlir_op_names.c mlir_api_common_literals.c mlir_lower_to_llvm.c mlir_translate_to_llvm_ir.c mlir_wasm_to_wat.c mlir_llvm_to_wasmssa.c mlir_wasmssa_to_wasmstack.c mlir_wasmstack_to_bin.c mlir_lift_cf_to_scf.c"
...
$CXX -g -o parser_upstream \
    ...
    op_parsers.o mlir_op_names.o mlir_api_common_literals.o mlir_lower_to_llvm.o mlir_translate_to_llvm_ir.o mlir_wasm_to_wat.o mlir_llvm_to_wasmssa.o mlir_wasmssa_to_wasmstack.o mlir_wasmstack_to_bin.o mlir_lift_cf_to_scf.o mlir_api_impl_upstream.o \
