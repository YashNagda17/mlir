...
PROJ_C_FILES="parser.c tokenizer.c mlir_parser.c mlir_classic_printer.c mlir_generic_printer.c op_parsers.c mlir_op_names.c mlir_lower_to_llvm.c mlir_translate_to_llvm_ir.c mlir_translate_to_wasm.c mlir_wasm_dialect.c mlir_lower_llvm_to_wasmssa.c mlir_stackify_wasmssa.c mlir_translate_wasmstack_to_binary.c"
...
$CXX -g -o parser_upstream \
    ...
    op_parsers.o mlir_op_names.o mlir_lower_to_llvm.o mlir_translate_to_llvm_ir.o mlir_translate_to_wasm.o mlir_wasm_dialect.o mlir_lower_llvm_to_wasmssa.o mlir_stackify_wasmssa.o mlir_translate_wasmstack_to_binary.o mlir_api_impl_upstream.o \
