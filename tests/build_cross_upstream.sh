...
PROJ_C_FILES="tests/cross/driver.c mlir_generic_printer.c mlir_op_names.c mlir_lower_to_llvm.c mlir_translate_to_llvm_ir.c mlir_translate_to_wasm.c"
...
$CXX -g -o cross_upstream \
    upstream_main.o driver.o mlir_generic_printer.o mlir_op_names.o mlir_lower_to_llvm.o mlir_translate_to_llvm_ir.o mlir_translate_to_wasm.o mlir_api_impl_upstream.o \
