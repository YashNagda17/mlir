...
TINYC_C_FILES="examples/tinyc/lex.c examples/tinyc/preprocess.c examples/tinyc/parse.c examples/tinyc/emit.c examples/tinyc/driver.c mlir_op_names.c mlir_api_common_literals.c mlir_lower_to_llvm.c mlir_translate_to_llvm_ir.c mlir_translate_to_wasm.c mlir_wasm_to_wat.c mlir_wasm_to_macho.c mlir_llvm_to_wasmssa.c mlir_wasmssa_to_wasmstack.c mlir_wasmstack_to_bin.c mlir_wasm_link.c mlir_wasm_to_wasmstack.c mlir_wasmstack_to_wasmssa.c mlir_wasmssa_to_llvm.c mlir_llvm_mem2reg.c mlir_llvm_load_cse.c mlir_llvm_arith_gvn.c mlir_llvm_dce.c mlir_regalloc.c mlir_llvm_to_aarch64.c mlir_aarch64_asm.c mlir_aarch64_to_macho.c mlir_llvm_to_x64.c mlir_elf.c mlir_generic_printer.c mlir_lift_cf_to_scf.c"
...
$CXX -g -o tinyc \
    upstream_main.o lex.o preprocess.o parse.o emit.o driver.o mlir_api_impl_upstream.o mlir_op_names.o mlir_api_common_literals.o mlir_lower_to_llvm.o mlir_translate_to_llvm_ir.o mlir_translate_to_wasm.o mlir_wasm_to_wat.o mlir_wasm_to_macho.o mlir_llvm_to_wasmssa.o mlir_wasmssa_to_wasmstack.o mlir_wasmstack_to_bin.o mlir_wasm_link.o mlir_wasm_to_wasmstack.o mlir_wasmstack_to_wasmssa.o mlir_wasmssa_to_llvm.o mlir_llvm_mem2reg.o mlir_llvm_load_cse.o mlir_llvm_arith_gvn.o mlir_llvm_dce.o mlir_regalloc.o mlir_llvm_to_aarch64.o mlir_aarch64_asm.o mlir_aarch64_to_macho.o mlir_llvm_to_x64.o mlir_elf.o mlir_generic_printer.o mlir_lift_cf_to_scf.o \
