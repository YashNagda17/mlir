...
TINYC_C_FILES="examples/tinyc/lex.c examples/tinyc/preprocess.c examples/tinyc/parse.c examples/tinyc/emit.c examples/tinyc/driver.c mlir_op_names.c mlir_lower_to_llvm.c mlir_translate_to_llvm_ir.c"
...
$CXX -g -o tinyc \
    upstream_main.o lex.o preprocess.o parse.o emit.o driver.o mlir_api_impl_upstream.o mlir_op_names.o mlir_lower_to_llvm.o mlir_translate_to_llvm_ir.o \
