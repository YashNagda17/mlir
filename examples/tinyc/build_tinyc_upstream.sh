...
TINYC_C_FILES="examples/tinyc/lex.c examples/tinyc/preprocess.c examples/tinyc/parse.c examples/tinyc/emit.c examples/tinyc/driver.c mlir_op_names.c mlir_lower_to_llvm.c mlir_translate_to_llvm_ir.c mlir_translate_to_wasm.c mlir_wasm_dialect.c mlir_lower_llvm_to_wasmssa.c mlir_stackify_wasmssa.c mlir_translate_wasmstack_to_binary.c"
...
$CXX -g -o tinyc \
    upstream_main.o lex.o preprocess.o parse.o emit.o driver.o mlir_api_impl_upstream.o mlir_op_names.o mlir_lower_to_llvm.o mlir_translate_to_llvm_ir.o mlir_translate_to_wasm.o mlir_wasm_dialect.o mlir_lower_llvm_to_wasmssa.o mlir_stackify_wasmssa.o mlir_translate_wasmstack_to_binary.o \
