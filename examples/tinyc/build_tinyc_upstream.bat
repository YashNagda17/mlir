...
set TINYC_C=examples\tinyc\lex.c examples\tinyc\preprocess.c examples\tinyc\parse.c examples\tinyc\emit.c examples\tinyc\driver.c mlir_op_names.c mlir_lower_to_llvm.c mlir_translate_to_llvm_ir.c mlir_wasm_to_wat.c mlir_llvm_to_wasmssa.c mlir_wasmssa_to_wasmstack.c mlir_wasmstack_to_bin.c mlir_generic_printer.c
...
link /nologo /out:tinyc.exe ^
    ...
    mlir_op_names.obj mlir_lower_to_llvm.obj mlir_translate_to_llvm_ir.objbj mlir_wasm_to_wat.obj mlir_llvm_to_wasmssa.obj mlir_wasmssa_to_wasmstack.obj mlir_wasmstack_to_bin.obj mlir_generic_printer.obj mlir_api_impl_upstream.obj ^
