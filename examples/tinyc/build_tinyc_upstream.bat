...
set TINYC_C=examples\tinyc\lex.c examples\tinyc\parse.c examples\tinyc\emit.c examples\tinyc\driver.c mlir_op_names.c
...
link /nologo /out:tinyc.exe ^
    upstream_main.obj lex.obj parse.obj emit.obj driver.obj ^
