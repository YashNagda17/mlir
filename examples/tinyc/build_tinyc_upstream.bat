...
set TINYC_C=examples\tinyc\lex.c examples\tinyc\preprocess.c examples\tinyc\parse.c examples\tinyc\emit.c examples\tinyc\driver.c mlir_op_names.c mlir_lower_to_llvm.c mlir_translate_to_llvm_ir.c mlir_translate_to_wasm.c mlir_wasm_print.c mlir_lower_llvm_to_wasmssa.c mlir_stackify_wasmssa.c mlir_translate_wasmstack_to_binary.c mlir_generic_printer.c
...
link /nologo /out:tinyc.exe ^
    ...
    mlir_op_names.obj mlir_lower_to_llvm.obj mlir_translate_to_llvm_ir.obj mlir_translate_to_wasm.objbj mlir_wasm_print.obj mlir_lower_llvm_to_wasmssa.obj mlir_stackify_wasmssa.obj mlir_translate_wasmstack_to_binary.obj mlir_generic_printer.obj mlir_api_impl_upstream.obj ^
