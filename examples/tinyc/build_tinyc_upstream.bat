...
set TINYC_C=examples\tinyc\lex.c examples\tinyc\preprocess.c examples\tinyc\parse.c examples\tinyc\emit.c examples\tinyc\driver.c mlir_op_names.c mlir_api_common_literals.c mlir_lower_to_llvm.c mlir_translate_to_llvm_ir.c mlir_translate_to_wasm.c mlir_wasm_to_wat.c mlir_wasm_to_macho.c mlir_llvm_to_wasmssa.c mlir_wasmssa_to_wasmstack.c mlir_wasmstack_to_bin.c mlir_wasm_link.c mlir_wasm_to_wasmstack.c mlir_wasmstack_to_wasmssa.c mlir_wasmssa_to_llvm.c mlir_llvm_mem2reg.c mlir_llvm_load_cse.c mlir_llvm_arith_gvn.c mlir_llvm_dce.c mlir_regalloc.c mlir_llvm_to_aarch64.c mlir_aarch64_asm.c mlir_aarch64_to_macho.c mlir_generic_printer.c mlir_lift_cf_to_scf.c
...
link /nologo /out:tinyc.exe ^
    ...
    mlir_op_names.obj mlir_api_common_literals.obj mlir_lower_to_llvm.obj mlir_translate_to_llvm_ir.obj mlir_translate_to_wasm.obj mlir_wasm_to_wat.obj mlir_wasm_to_macho.obj mlir_llvm_to_wasmssa.obj mlir_wasmssa_to_wasmstack.obj mlir_wasmstack_to_bin.obj mlir_wasm_link.obj mlir_wasm_to_wasmstack.obj mlir_wasmstack_to_wasmssa.obj mlir_wasmssa_to_llvm.obj mlir_llvm_mem2reg.obj mlir_llvm_load_cse.obj mlir_llvm_arith_gvn.obj mlir_llvm_dce.obj mlir_regalloc.obj mlir_llvm_to_aarch64.obj mlir_aarch64_asm.obj mlir_aarch64_to_macho.obj mlir_generic_printer.obj mlir_lift_cf_to_scf.obj mlir_api_impl_upstream.obj ^
