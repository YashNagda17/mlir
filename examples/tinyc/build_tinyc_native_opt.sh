...
NATIVE_C_FILES="mlir_api_impl.c mlir_api_common_literals.c mlir_op_names.c mlir_lower_to_llvm.c mlir_translate_to_llvm_ir.c mlir_translate_to_wasm.c mlir_wasm_to_wat.c mlir_wasm_to_macho.c mlir_llvm_to_wasmssa.c mlir_wasmssa_to_wasmstack.c mlir_wasmstack_to_bin.c mlir_wasm_link.c mlir_wasm_to_wasmstack.c mlir_wasmstack_to_wasmssa.c mlir_wasmssa_to_llvm.c mlir_llvm_mem2reg.c mlir_llvm_load_cse.c mlir_llvm_arith_gvn.c mlir_llvm_dce.c mlir_regalloc.c mlir_llvm_to_aarch64.c mlir_aarch64_asm.c mlir_aarch64_to_macho.c mlir_llvm_to_x64.c mlir_elf.c tokenizer.c mlir_parser.c op_parsers.c mlir_classic_printer.c mlir_generic_printer.c mlir_lift_cf_to_scf.c"
...
$CC $OPT_FLAGS -o tinyc_native_opt \
    ...
    "$OBJ_DIR"/mlir_api_impl.o "$OBJ_DIR"/mlir_api_common_literals.o "$OBJ_DIR"/mlir_op_names.o "$OBJ_DIR"/mlir_lower_to_llvm.o \
