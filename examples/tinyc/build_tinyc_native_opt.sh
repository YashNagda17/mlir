...
$CC $OPT_FLAGS -o tinyc_native_opt \
    ...
    "$OBJ_DIR"/mlir_wasm_link.o "$OBJ_DIR"/mlir_wasm_to_wasmstack.o "$OBJ_DIR"/mlir_wasmstack_to_wasmssa.o "$OBJ_DIR"/mlir_wasmssa_to_wmir.o "$OBJ_DIR"/mlir_wasmssa_to_llvm.o "$OBJ_DIR"/mlir_llvm_mem2reg.o mlir_wmir_mem2reg.o "$OBJ_DIR"/mlir_wmir_regalloc.o "$OBJ_DIR"/mlir_wmir_to_aarch64.o mlir_llvm_to_aarch64.o \
