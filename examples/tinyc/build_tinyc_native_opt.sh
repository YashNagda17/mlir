...
$CC $OPT_FLAGS -o tinyc_native_opt \
    ...
    "$OBJ_DIR"/mlir_wasm_link.o "$OBJ_DIR"/mlir_wasm_to_wasmstack.o "$OBJ_DIR"/mlir_wasmstack_to_wasmssa.o "$OBJ_DIR"/mlir_wasmssa_to_llvm.o "$OBJ_DIR"/mlir_llvm_mem2reg.o mlir_llvm_load_cse.o mlir_llvm_arith_gvn.o mlir_llvm_dce.o mlir_llvm_to_aarch64.o \
    "$OBJ_DIR"/mlir_aarch64_to_macho.o "$OBJ_DIR"/mlir_llvm_to_x64.o "$OBJ_DIR"/mlir_elf.o \
