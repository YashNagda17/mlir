...
#line 149 "tokenizer.re"
	{ RET(TK_REAL) }
#line 539 "tokenizer.c"
yy53:
	++cur;
#line 138 "tokenizer.re"
	{ RET(TK_COMMENT) }
#line 544 "tokenizer.c"
yy54:
	yych = *++cur;
	if (yych <= ',') {
		if (yych == '+') goto yy63;
