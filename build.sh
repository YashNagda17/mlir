...
clang $CFLAGS -I. -o parser parser.c tokenizer.c mlir_parser.c mlir_generic_printer.c mlir_classic_printer.c op_parsers.c base/arena.c base/string.c base/format.c base/io.c
./parser
./parser --construct
